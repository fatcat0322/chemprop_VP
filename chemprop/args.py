...
class TrainArgs(CommonArgs):
    ...
    """Name of the columns containing temperature datas."""
    ...
    split_type: Literal['random', 'scaffold_balanced', 'predetermined', 'crossval', 'cv',
                        'cv-no-test', 'index_predetermined', 'random_with_repeated_smiles'] = 'random'
    ...
    earlystop: int = 30
    """
    If validation score not improve for this epochs, stop training to prevent overfitting.
    """
    manual_temp_scaling: float = None
    """
    Manually choose the max temperature for scaling.
    """
    ...
    """
    equation: Literal['Tu', 'Antonine', 'Riedel', 'Wagner25'] = None
    """
    Choice of equation to use for empirical model.
    None means no empirical equation is used.
    """
    Tconcat: bool = False
    """
    Whether to concatenate the temperature to the input.
    """
